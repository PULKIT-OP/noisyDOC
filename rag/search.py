...
class RAGSearch:
    ...
    def search_and_summarize(self, query: str, top_k: int = 5, min_score: float = 0.5) -> str:
        ...
        context = "\n\n".join(texts)
        if not context:
            return "\nNo relevant documents found.(No LLM)"
        prompt = f"""Answer ONLY based on the provided context. 
                    If the context does not contain relevant information, respond with: "The provided context does not contain information about this topic(LLM)."
